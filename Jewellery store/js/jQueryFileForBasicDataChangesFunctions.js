var dataSetForBasicData={
				...
				"BrandNameOrPersonName": " Luxury Floral",
				"NavOrAddressBrandName": " Luxury Floral",
				...
				"OurWebsiteURL":" Luxury Floral",
				"FollowLinkFacebook": "#!",
				"FollowLinkInstagram": "#!",
				"FollowLinkTwitter": "#!",
				"FollowLinkYouTube": "#!",
				"BrandAboutUs": "A jewelry store is a dazzling haven for adornment, showcasing an exquisite collection of precious gems, metals, and artistic designs. From engagement rings to statement necklaces, these stores offer a curated selection that caters to diverse tastes and occasions. Knowledgeable staff guide customers through the world of fine jewelry, helping them find the perfect piece to celebrate milestones or express personal style. Whether it's a classic diamond ring, a trendy fashion accessory, or a custom-designed masterpiece, a jewelry store is a place where emotions and craftsmanship converge, turning every purchase into a cherished symbol of elegance and sentiment. ",
				...
				"FeedbackReviewFirst":"best place for buying Luxury Jewellery",
				"FeedbackReviewSecond":"good staff",
				"FeedbackReviewThird":"best golden jewellery"
			}
